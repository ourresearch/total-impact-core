...
def make_reference_sets(query_templates, years, sample_size, seed):
    collection_ids = []
...
#make_reference_sets(query_templates, years=range(2001, 2012), sample_size=50, seed=42)
make_reference_sets(query_templates, years=range(2011, 2012), sample_size=5, seed=42)
