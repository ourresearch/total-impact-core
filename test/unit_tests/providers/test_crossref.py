...
class TestCrossRef(ProviderTestCase):
    ...
    def test_extract_biblio(self):
        ...
        expected = {'authors': 'Piwowar, Day, Fridsma, Eisen', 'journal': u'PLoS ONE', 'title': u'Sharing Detailed Research Data Is Associated with Increased Citation Rate', 'year': u'2007'}
