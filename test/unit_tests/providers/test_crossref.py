...
class TestCrossRef(ProviderTestCase):
    ...
    def test_biblio_dryad(self):
        ...
        expected = {'title': u'Data from: Public sharing of research datasets: a pilot study of associations', 'year': u'2011', 'repository': u'Dryad Digital Repository', 'authors': u'Piwowar, Heather A.; Chapman, Wendy W.'}
        print biblio
        assert_equals(biblio, expected) 
