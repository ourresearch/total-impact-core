...
class TestCrossRef(ProviderTestCase):
    ...
    def test_biblio_figshare(self):
        ...
        expected = {'title': u'Leave One Out N15 Prediction Analysis', 'year': u'2011', 'repository': u'Figshare', 'authors_literal': u'Antony Williams'}
        print biblio
        assert_equals(biblio, expected) 
    ...
    def test_aliases_from_biblio2(self):
        ...
        response = self.provider.aliases([("biblio", biblio)])
        print response
        expected = [('biblio', {'repository': u'Wiley Blackwell (John Wiley & Sons)', 'title': u'Evaluating data citation and sharing policies in the environmental sciences', 'journal': u'Proceedings of the American Society for Information Science and Technology', 'year': 2010, 'authors': u'Weber, Piwowar, Vision'}), ('doi', u'10.1002/meet.14504701445'), ('url', u'http://dx.doi.org/10.1002/meet.14504701445'), ('url', u'http://onlinelibrary.wiley.com/doi/10.1002/meet.14504701445/abstract;jsessionid=B5ECFC6B10DD4551DC88458D2F3C5CAB.d02t04')]
        assert_equals(response, expected)
