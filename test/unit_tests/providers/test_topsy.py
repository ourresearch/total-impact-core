...
class TestTopsy(ProviderTestCase):
    ...
    def test_metrics(self):
        ...
        expected = {'topsy:influential_tweets': (7, 'http://topsy.com/trackback?url=http%3A//total-impact.org'), 'topsy:tweets': (47, 'http://topsy.com/trackback?url=http%3A//total-impact.org')}
        print metrics_dict
        for key in expected:
