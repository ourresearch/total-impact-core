...
class TestOrcid(ProviderTestCase):
    ...
    def test_extract_members3(self):
        ...
        print members
        expected = [('biblio', {'isbn': '0702251879', 'title': 'Moving Among Strangers: Randolph Stow and My Family', 'url': '', 'journal': '', 'year': '2013', 'authors': '', 'genre': 'book'}), ('biblio', {'title': 'Randolph Stow: An Ambivalent Australian', 'url': '', 'journal': 'Kill Your Darlings', 'year': '2013', 'authors': '', 'genre': 'journal article'}), ('biblio', {'isbn': '1742759297', 'title': 'Puberty blues', 'url': '', 'journal': '', 'year': '2012', 'authors': '', 'genre': 'book'}), ('biblio', {'title': 'Moving Among Strangers, Darkly', 'url': '', 'journal': '', 'year': '2010', 'authors': '', 'genre': 'journal article'}), ('biblio', {'title': 'High-value niche production: what Australian wineries might learn from a Bordeaux first growth', 'url': '', 'journal': 'International journal of technology, policy and management', 'year': '2009', 'authors': '', 'genre': 'journal article'}), ('biblio', {'isbn': '1921372621', 'title': 'Waiting Room: A Memoir', 'url': '', 'journal': '', 'year': '2009', 'authors': '', 'genre': 'book'}), ('biblio', {'title': 'Literature and Religion as Rivals', 'url': '', 'journal': 'Sydney Studies in Religion', 'year': '2008', 'authors': '', 'genre': 'journal article'}), ('doi', '10.1162/daed.2006.135.4.60'), ('biblio', {'isbn': '0733305741', 'title': 'Australian Story: Australian Lives', 'url': '', 'journal': '', 'year': '1997', 'authors': '', 'genre': 'book'}), ('biblio', {'isbn': '0140259384', 'title': 'The Penguin Book of Death', 'url': '', 'journal': '', 'year': '1997', 'authors': '', 'genre': 'book'}), ('biblio', {'title': 'Prenatal Depression, Postmodern World', 'url': '', 'journal': 'Mother love: stories about births, babies & beyond', 'year': '1996', 'authors': '', 'genre': 'journal article'}), ('biblio', {'isbn': '0330355988', 'title': 'The Borrowed Girl', 'url': '', 'journal': '', 'year': '1994', 'authors': '', 'genre': 'book'}), ('biblio', {'isbn': '0330272942', 'title': "In My Father's House", 'url': '', 'journal': '', 'year': '1992', 'authors': '', 'genre': 'book'}), ('biblio', {'isbn': '0140074252', 'title': 'Just Us', 'url': '', 'journal': '', 'year': '1984', 'authors': '', 'genre': 'book'}), ('biblio', {'isbn': '0872237680', 'title': 'Puberty blues', 'url': '', 'journal': '', 'year': '1982', 'authors': '', 'genre': 'book'})]
        print expected
