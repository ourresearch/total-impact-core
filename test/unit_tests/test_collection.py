...
class TestCollection():
    ...
    def test_get_metric_values_of_reference_sets(self):
        ...
        print response
        expected = {'dryad:package_views': [537, 0, 0, 0], 'facebook:shares': [0, 0, 0, 0], 'mendeley:country': [0, 0, 0, 0], 'mendeley:career_stage': [0, 0, 0, 0], 'mendeley:readers': [57, 52, 13, 0], 'dryad:total_downloads': [114, 0, 0, 0], 'mendeley:groups': [4, 4, 1, 0], 'scopus:citations': [0, 0, 0, 0], 'figshare:downloads': [0, 0, 0, 0], 'topsy:influential_tweets': [0, 0, 0, 0], 'topsy:tweets': [0, 0, 0, 0], 'github:forks': [0, 0, 0, 0], 'scienceseeker:blog_posts': [0, 0, 0, 0], 'pubmed:pmc_citations_reviews': [0, 0, 0, 0], 'pubmed:pmc_citations_editorials': [0, 0, 0, 0], 'pubmed:pmc_citations': [0, 0, 0, 0], 'facebook:comments': [0, 0, 0, 0], 'delicious:bookmarks': [0, 0, 0, 0], 'citeulike:bookmarks': [0, 0, 0, 0], 'pubmed:f1000': [0, 0, 0, 0], 'facebook:likes': [0, 0, 0, 0], 'github:watchers': [0, 0, 0, 0], 'figshare:shares': [0, 0, 0, 0], 'facebook:clicks': [0, 0, 0, 0], 'wikipedia:mentions': [1, 0, 0, 0], 'slideshare:downloads': [0, 0, 0, 0], 'slideshare:favorites': [0, 0, 0, 0], 'slideshare:views': [0, 0, 0, 0], 'mendeley:discipline': [0, 0, 0, 0], 'figshare:views': [0, 0, 0, 0], 'slideshare:comments': [0, 0, 0, 0]}
        assert_equals(response, expected)
